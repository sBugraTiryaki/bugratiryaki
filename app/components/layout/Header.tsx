    ...
    >
      <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
        <Link
          ...
          aria-label="Buğra Tiryaki — Ana sayfa"
        >
          Buğra Tiryaki
        </Link>
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <Link
            href="/iletisim"
            className="px-5 py-2 text-sm tracking-wide border transition-all duration-300 hover:bg-[var(--accent-gold)] hover:text-[var(--luxury-black)]"
            style={{
